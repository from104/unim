...
## 출력
- `docs/dev/release/0.2.0/TEST_CHECKLIST.md` — 사용자용 체크리스트 (한국어)
- `docs/dev/release/0.2.0/TEST_CHECKLIST-en.md` (영어 짝)
- `docs/dev/release/0.2.0/TEST_AUTOMATION.md` — 자동 커버리지 매핑
