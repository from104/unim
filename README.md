...
<p align="center">
  ...
  <img alt="version 0.4.4" src="https://img.shields.io/badge/version-0.4.4-informational">
...
# 버전 고정
UNIM_VERSION=v0.4.4 curl -fsSL .../install.sh | bash
```
...
$env:UNIM_VERSION='v0.4.4'; irm .../install.ps1 | iex
```
