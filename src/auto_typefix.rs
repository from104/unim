...
mod tests {
    ...
    fn test_forward_gksrmf() {
        ...
        let result = check_forward(&buf, &config, "ko_2bulstd", EnglishLayout::Qwerty, &empty_bl());
    ...
    fn test_reverse_hello() {
        ...
        let result = check_reverse(&buf, &config, "ko_2bulstd", EnglishLayout::Qwerty, &empty_bl());
        assert!(result.is_some());
        let r = result.unwrap();
    ...
    fn test_forward_incomplete_syllable_skip_3set() {
        ...
        let result = check_forward(&buf, &config, "ko_3bul390", EnglishLayout::Qwerty, &empty_bl());
    ...
    fn test_forward_incomplete_syllable_skip_2set() {
        ...
        let ascii = "preedit";
        let converted = crate::typefix::eng_to_kor(ascii, "ko_2bulstd", EnglishLayout::Qwerty);
        let chars: Vec<char> = converted.chars().collect();
    ...
    fn test_forward_dvorak() {
        ...
        // Qwerty: "gksrmf" → "한글"
        let result_qwerty = check_forward(&buf, &config, "ko_2bulstd", EnglishLayout::Qwerty, &empty_bl());
        assert!(result_qwerty.is_some());
        assert_eq!(result_qwerty.unwrap().corrected, "한글");

        // Dvorak: 같은 물리키 → 같은 한글 결과 (순방향은 물리키 기반)
        let result_dvorak = check_forward(&buf, &config, "ko_2bulstd", EnglishLayout::Dvorak, &empty_bl());
    ...
    fn test_reverse_dvorak_hello() {
        ...
        let result = check_reverse(&buf, &config, "ko_2bulstd", EnglishLayout::Dvorak, &empty_bl());
    ...
    fn test_reverse_colemak_hello() {
        ...
        let result = check_reverse(&buf, &config, "ko_2bulstd", EnglishLayout::Colemak, &empty_bl());
    ...
    fn test_reverse_asymmetry_qwerty_vs_dvorak() {
        ...
        // Qwerty: "hello" → 사전에 있음
        let result_qwerty = check_reverse(&buf, &config, "ko_2bulstd", EnglishLayout::Qwerty, &empty_bl());
        assert!(result_qwerty.is_some());
        assert_eq!(result_qwerty.unwrap().corrected, "hello");

        // Dvorak: 같은 물리키지만 다른 문자열 → 사전에 없을 가능성 높음
        let result_dvorak = check_reverse(&buf, &config, "ko_2bulstd", EnglishLayout::Dvorak, &empty_bl());
    ...
    fn test_reverse_workman_world() {
        ...
        let result = check_reverse(&buf, &config, "ko_2bulstd", EnglishLayout::Workman, &empty_bl());
    ...
    fn test_forward_skip_on_english_word_toggle_off() {
        ...
        assert!(
            check_forward(&buf, &on, "ko_2bulstd", EnglishLayout::Qwerty, &empty_bl()).is_none(),
        ...
        let converted = typefix::eng_to_kor("hello", "ko_2bulstd", EnglishLayout::Qwerty);
        let sylls = count_korean_syllables(&converted);
        let result = check_forward(&buf, &off, "ko_2bulstd", EnglishLayout::Qwerty, &empty_bl());
    ...
    fn test_reverse_skip_on_complete_syllable_on_suppresses() {
        ...
        assert!(
            check_reverse(&buf, &on, "ko_2bulstd", EnglishLayout::Qwerty, &empty_bl()).is_none(),
    ...
    fn test_reverse_skip_on_complete_syllable_off_triggers() {
        ...
        let result = check_reverse(&buf, &off, "ko_2bulstd", EnglishLayout::Qwerty, &empty_bl());
        assert!(
            result.is_some(),
    ...
    fn test_reverse_with_preedit_always_triggers_regardless_of_toggle() {
        ...
        let result = check_reverse(&buf, &on, "ko_2bulstd", EnglishLayout::Qwerty, &empty_bl());
        assert!(
            result.is_some(),
    ...
    fn forward_suppressed_by_tentative_blacklist() {
        ...
        let result = check_forward(&buf, &config, "ko_2bulstd", EnglishLayout::Qwerty, &bl);
    ...
    fn forward_layout_mismatch_not_suppressed() {
        ...
        let result = check_forward(&buf, &config, "ko_2bulstd", EnglishLayout::Dvorak, &bl);
    ...
    fn reverse_suppressed_by_tentative_blacklist() {
        ...
        let mut bl = Blacklist::default();
        bl.add_or_hit_tentative("hello", Direction::Reverse, "ko_2bulstd", EnglishLayout::Qwerty);

        let result = check_reverse(&buf, &config, "ko_2bulstd", EnglishLayout::Qwerty, &bl);
    ...
    fn reverse_rollback_suppression_cycle() {
        ...
        let mut bl = Blacklist::default();
        let fix = check_reverse(&buf, &config, "ko_2bulstd", EnglishLayout::Qwerty, &bl)
        ...
        let result2 =
            check_reverse(&buf2, &config, "ko_2bulstd", EnglishLayout::Qwerty, &bl);
        assert!(
            result2.is_none(),
    ...
    fn reverse_direction_mismatch_not_suppressed() {
        ...
        bl.add_or_hit_tentative("hello", Direction::Forward, "ko_2bulstd", EnglishLayout::Qwerty);
